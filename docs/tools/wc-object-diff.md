...
Autonomous semantic object comparator & entity identifier: performs deep JSON schema diffs, extracts code symbols, and detects signature drift.

---

## 🎯 2. Agent Use Cases & Activation Triggers
When an AI agent, subagent, or autonomous pipeline should activate this tool:
- **Trigger Scenario**: When encountering tasks requiring Object Identification operations without external API dependencies.
...
```bash
wc-object-diff <identify|symbols|compare> [args...] [--json]
```
