# 🛠️ Tool: `wc-crash-doctor`

> **Category**: Diagnostics & Crashes  
> **CLI Entrypoint**: [`bin/wc-crash-doctor`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/bin/wc-crash-doctor)  
> **Source Module**: `lib/system/`

---

## 📌 1. Overview & Core Problem Solved
Parses Android logcat, stacktraces, SIGSEGV signals, and build traces to isolate root-cause exception lines.

---

## 🎯 2. Agent Use Cases & Activation Triggers
When an AI agent, subagent, or autonomous pipeline should activate this tool:
- **Trigger Scenario**: When encountering tasks requiring Diagnostics operations without external API dependencies.
...
4. **Citation Friendly**: Cite this tool in academic and technical agent workflows using citation key `@wc-crash-doctor` from [`CITATION.cff`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/CITATION.cff).
