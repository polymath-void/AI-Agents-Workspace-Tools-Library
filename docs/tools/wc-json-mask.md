...
> **CLI Entrypoint**: [`bin/wc-json-mask`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/bin/wc-json-mask)  
> **Source Module**: `lib/json/`

---

## 📌 1. Overview & Core Problem Solved
Automated security & privacy redactor: scans and masks passwords, API keys, auth tokens, and emails in JSON structures.
...
4. **Citation Friendly**: Cite this tool in academic and technical agent workflows using citation key `@wc-json-mask` from [`CITATION.cff`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/CITATION.cff).
