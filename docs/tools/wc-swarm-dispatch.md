# 🛠️ Tool: `wc-swarm-dispatch`

> **Category**: Multi-Tasking & Workflows  
> **CLI Entrypoint**: [`bin/wc-swarm-dispatch`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/bin/wc-swarm-dispatch)  
> **Source Module**: `lib/workflow/`

---

## 📌 1. Overview & Core Problem Solved
Subagent swarm evaluation, dispatch payload synthesizer & consensus barrier aggregator.
...
```bash
wc-swarm-dispatch <eval|spec|aggregate> [args...]
```
...
4. **Citation Friendly**: Cite this tool in academic and technical agent workflows using citation key `@wc-swarm-dispatch` from [`CITATION.cff`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/CITATION.cff).
