# 🛠️ Tool: `wc-json-ndjson`

> **Category**: JSON & Data Processing  
> **CLI Entrypoint**: [`bin/wc-json-ndjson`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/bin/wc-json-ndjson)  
> **Source Module**: `lib/json/`

---

## 📌 1. Overview & Core Problem Solved
High-throughput NDJSON (Newline Delimited JSON) / JSONL converter and memory-efficient streaming line filter.
...
```bash
wc-json-ndjson <to-ndjson|to-json|filter> [target] [-k key] [-v val]
```
...
4. **Citation Friendly**: Cite this tool in academic and technical agent workflows using citation key `@wc-json-ndjson` from [`CITATION.cff`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/CITATION.cff).
