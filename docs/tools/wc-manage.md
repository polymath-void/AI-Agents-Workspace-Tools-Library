...
> **CLI Entrypoint**: [`bin/wc-manage`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/bin/wc-manage)  
> **Source Module**: `lib/system/`

---

## 📌 1. Overview & Core Problem Solved
Safely sanitizes build artifacts, temporary logs, and orphan caches with protected root bounds and dry-run preview.

---

## 🎯 2. Agent Use Cases & Activation Triggers
When an AI agent, subagent, or autonomous pipeline should activate this tool:
- **Trigger Scenario**: When encountering tasks requiring Workspace Maintenance operations without external API dependencies.
...
```bash
wc-manage sanitize <directory> <pattern1> [pattern2...] [--dry-run]
```
...
4. **Citation Friendly**: Cite this tool in academic and technical agent workflows using citation key `@wc-manage` from [`CITATION.cff`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/CITATION.cff).
