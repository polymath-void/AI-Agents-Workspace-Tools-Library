# 🛠️ Tool: `wc-json-flatten`

> **Category**: JSON & Data Processing  
> **CLI Entrypoint**: [`bin/wc-json-flatten`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/bin/wc-json-flatten)  
> **Source Module**: `lib/json/`

---

## 📌 1. Overview & Core Problem Solved
Bidirectional JSON flattener & un-flattener for converting deep object hierarchies to dot-notation keys.
...
```bash
wc-json-flatten <flatten|unflatten> [target] [-d delimiter]
```
...
4. **Citation Friendly**: Cite this tool in academic and technical agent workflows using citation key `@wc-json-flatten` from [`CITATION.cff`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/CITATION.cff).
