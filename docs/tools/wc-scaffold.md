...
> **CLI Entrypoint**: [`bin/wc-scaffold`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/bin/wc-scaffold)  
> **Source Module**: `lib/py/`

---

## 📌 1. Overview & Core Problem Solved
Zero-overhead component generator for Jetpack Compose UI, Kotlin StateFlow repositories, and extension bundles.

---

## 🎯 2. Agent Use Cases & Activation Triggers
When an AI agent, subagent, or autonomous pipeline should activate this tool:
- **Trigger Scenario**: When encountering tasks requiring Code Scaffolding operations without external API dependencies.
...
```bash
wc-scaffold <compose|repo|extension> [args...]
```
...
4. **Citation Friendly**: Cite this tool in academic and technical agent workflows using citation key `@wc-scaffold` from [`CITATION.cff`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/CITATION.cff).
