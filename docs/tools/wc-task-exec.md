...
> **CLI Entrypoint**: [`bin/wc-task-exec`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/bin/wc-task-exec)  
> **Source Module**: `lib/system/`

---

## 📌 1. Overview & Core Problem Solved
Executes complete multi-phase task validation pipelines (environment, dependencies, health audit, tests) and generates receipts.

---

## 🎯 2. Agent Use Cases & Activation Triggers
When an AI agent, subagent, or autonomous pipeline should activate this tool:
- **Trigger Scenario**: When encountering tasks requiring Task Automation operations without external API dependencies.
...
```bash
wc-task-exec [task_title] [path] [--json]
```
...
4. **Citation Friendly**: Cite this tool in academic and technical agent workflows using citation key `@wc-task-exec` from [`CITATION.cff`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/CITATION.cff).
