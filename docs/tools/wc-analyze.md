...
> **CLI Entrypoint**: [`bin/wc-analyze`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/bin/wc-analyze)  
> **Source Module**: `lib/py/`

---

## 📌 1. Overview & Core Problem Solved
Calculates cyclomatic complexity, lines of code (LOC), functions, and structural metrics for codebase files.
...
```bash
wc-analyze <complexity|metrics|summary> [directory]
```
...
4. **Citation Friendly**: Cite this tool in academic and technical agent workflows using citation key `@wc-analyze` from [`CITATION.cff`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/CITATION.cff).
