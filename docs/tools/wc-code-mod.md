...
> **CLI Entrypoint**: [`bin/wc-code-mod`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/bin/wc-code-mod)  
> **Source Module**: `lib/py/`

---

## 📌 1. Overview & Core Problem Solved
Atomic multi-file code modifier, regex replacer, and import injector with automatic safety backups and rollback.

---

## 🎯 2. Agent Use Cases & Activation Triggers
When an AI agent, subagent, or autonomous pipeline should activate this tool:
- **Trigger Scenario**: When encountering tasks requiring Code Refactoring operations without external API dependencies.
...
```bash
wc-code-mod <replace|import> [args...] [-e ext] [-d]
```
...
4. **Citation Friendly**: Cite this tool in academic and technical agent workflows using citation key `@wc-code-mod` from [`CITATION.cff`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/CITATION.cff).
