# 🛠️ Tool: `wc-agent-probe`

> **Category**: Agent Loop & Autonomy  
> **CLI Entrypoint**: [`bin/wc-agent-probe`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/bin/wc-agent-probe)  
> **Source Module**: `lib/workflow/`

---

## 📌 1. Overview & Core Problem Solved
Internal agent environment diagnostic probe: audits PATH, GitHub CLI auth, memory limits, and Python engines.
...
4. **Citation Friendly**: Cite this tool in academic and technical agent workflows using citation key `@wc-agent-probe` from [`CITATION.cff`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/CITATION.cff).
