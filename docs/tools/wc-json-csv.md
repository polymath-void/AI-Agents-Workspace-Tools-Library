...
> **CLI Entrypoint**: [`bin/wc-json-csv`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/bin/wc-json-csv)  
> **Source Module**: `lib/json/`

---

## 📌 1. Overview & Core Problem Solved
Bidirectional tabular bridge: converts JSON arrays to standard CSV/TSV and parses CSV tables into typed JSON.
...
```bash
wc-json-csv <to-csv|to-json> [target] [-t]
```
...
4. **Citation Friendly**: Cite this tool in academic and technical agent workflows using citation key `@wc-json-csv` from [`CITATION.cff`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/CITATION.cff).
