# 🛠️ Tool: `wc-context-pack`

> **Category**: Multi-Tasking & Workflows  
> **CLI Entrypoint**: [`bin/wc-context-pack`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/bin/wc-context-pack)  
> **Source Module**: `lib/workflow/`

---

## 📌 1. Overview & Core Problem Solved
Context window & token density compressor: strips ANSI codes, deduplicates traces, and packs multi-task payloads.
...
```bash
wc-context-pack [files...] [-m max_lines]
```
...
4. **Citation Friendly**: Cite this tool in academic and technical agent workflows using citation key `@wc-context-pack` from [`CITATION.cff`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/CITATION.cff).
