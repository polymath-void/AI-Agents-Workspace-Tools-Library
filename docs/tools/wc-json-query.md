# 🛠️ Tool: `wc-json-query`

> **Category**: JSON & Data Processing  
> **CLI Entrypoint**: [`bin/wc-json-query`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/bin/wc-json-query)  
> **Source Module**: `lib/json/`

---

## 📌 1. Overview & Core Problem Solved
Lightning-fast dot/bracket JSONPath query & token minifier engine: extracts nested keys and compresses JSON payloads.
...
```bash
wc-json-query [path_expr] [target] [-m] [--raw]
```
...
4. **Citation Friendly**: Cite this tool in academic and technical agent workflows using citation key `@wc-json-query` from [`CITATION.cff`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/CITATION.cff).
