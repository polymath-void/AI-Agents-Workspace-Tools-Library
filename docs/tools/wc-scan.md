...
> **CLI Entrypoint**: [`bin/wc-scan`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/bin/wc-scan)  
> **Source Module**: `lib/system/`

---

## 📌 1. Overview & Core Problem Solved
Recursively scans workspace directory tree, builds resilient JSON maps, and computes aggregate file/dir metrics.
...
4. **Citation Friendly**: Cite this tool in academic and technical agent workflows using citation key `@wc-scan` from [`CITATION.cff`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/CITATION.cff).
