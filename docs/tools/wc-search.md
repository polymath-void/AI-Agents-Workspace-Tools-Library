...
> **CLI Entrypoint**: [`bin/wc-search`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/bin/wc-search)  
> **Source Module**: `lib/py/`

---

## 📌 1. Overview & Core Problem Solved
Context-aware lightning-fast symbol, regex, and text finder that automatically ignores build/cache noise directories.

---

## 🎯 2. Agent Use Cases & Activation Triggers
When an AI agent, subagent, or autonomous pipeline should activate this tool:
- **Trigger Scenario**: When encountering tasks requiring Inspection operations without external API dependencies.
...
```bash
wc-search <query> [path] [-e ext] [-C lines] [--json]
```
...
4. **Citation Friendly**: Cite this tool in academic and technical agent workflows using citation key `@wc-search` from [`CITATION.cff`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/CITATION.cff).
