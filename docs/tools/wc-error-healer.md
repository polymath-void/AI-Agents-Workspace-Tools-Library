# 🛠️ Tool: `wc-error-healer`

> **Category**: Agent Loop & Autonomy  
> **CLI Entrypoint**: [`bin/wc-error-healer`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/bin/wc-error-healer)  
> **Source Module**: `lib/workflow/`

---

## 📌 1. Overview & Core Problem Solved
Deterministic self-healing error doctor: remediates Git 403s, missing Termux shebangs, and SQLite database locks.
...
```bash
wc-error-healer [error_text] [--fix-path]
```
...
4. **Citation Friendly**: Cite this tool in academic and technical agent workflows using citation key `@wc-error-healer` from [`CITATION.cff`](file:///data/data/com.termux/files/home/AI-Agents-Workspace-Tools-Library/CITATION.cff).
